...
describe('If Directive', () => {
  describe('parseIfArguments', () => {
    ...
    it('should throw on unbalanced parentheses', () => {
      expect(() => ifDirective.parseArguments!('(a > 5')).toThrow(
        APTLSyntaxError,
      );
    });
  });
  ...
  describe('validateElifDirective', () => {
    ...
    it('should throw if no condition provided', () => {
      ...
      expect(() => elifDirective.validate!(node)).toThrow(
  ...
  describe('validateElseDirective', () => {
    ...
    it('should throw if arguments provided', () => {
      ...
      expect(() => elseDirective.validate!(node)).toThrow(
  ...
  describe('ifDirective handler', () => {
      ...
      return {
        ...
        renderTemplate: (
          ...
          return childrenToRender
            .map((child: any) =>
              child.type === NodeType.TEXT ? child.value : '',
            )
            .join('');
        },
      };
    ...
    it('should throw if renderTemplate is not available', () => {
      ...
      expect(() => ifDirective.handler(context)).toThrow(
  ...
  describe('elif/else handling', () => {
    ...
    it('should render elif branch when if condition is false', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'age >= 18',
        children: [createTextNode('Adult'), elifNode],
        line: 1,
        column: 1,
      };
    ...
    it('should render else branch when all conditions are false', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'age >= 18',
        children: [createTextNode('Adult'), elifNode, elseNode],
        line: 1,
        column: 1,
      };
    ...
    it('should render only first true condition (if before elif)', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'age >= 15',
        children: [createTextNode('First true'), elifNode],
        line: 1,
        column: 1,
      };
    ...
    it('should skip elif when if is true', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'true',
        children: [createTextNode('If'), elifNode],
        line: 1,
        column: 1,
      };
    ...
    it('should handle multiple elif branches', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'age >= 18',
        children: [createTextNode('Adult'), elif1, elif2],
        line: 1,
        column: 1,
      };
  ...
  describe('nested if directives', () => {
    ...
    it('should handle nested if directives', () => {
      ...
      const node: DirectiveNode = {
        ...
        name: 'if',
        rawArgs: 'age >= 18',
        children: [createTextNode('Adult: '), nestedIf],
        line: 1,
        column: 1,
      };
  ...
  describe('elifDirective handler', () => {
    it('should throw when called independently', () => {
      ...
      expect(() => elifDirective.handler(context)).toThrow(
        'must be used within an @if block',
      );
    });
  });
  ...
  describe('elseDirective handler', () => {
    it('should throw when called independently', () => {
      ...
      expect(() => elseDirective.handler(context)).toThrow(
        'must be used within an @if block',
      );
    });
  });
