...
describe('Argument Parsers - The String Surgeons', () => {
    describe('parseAttributes - The Key-Value Extractor', () => {
        ...
        it('should handle special characters in values', () => {
            const result = parseAttributes('path="/usr/local/bin", email="user@example.com"');
            expect(result).toEqual({
                path: '/usr/local/bin',
    ...
    describe('parseSectionArgs - The Section Specialist', () => {
        ...
        it('should handle complex attribute values', () => {
            const result = parseSectionArgs('section(class="btn btn-primary", id="submit-btn")');
            expect(result).toEqual({
                name: 'section',
                attributes: {
    ...
    describe('parseNamedParams - The Parameter Juggler', () => {
        ...
        it('should handle complex quoted values', () => {
            const result = parseNamedParams('path="/usr/local/bin", command="echo \\"hello\\""');
            expect(result).toEqual({
                positional: [],
                named: {
                    path: '/usr/local/bin',
    ...
    describe('Real-world Scenarios - Battle-tested', () => {
        it('should parse section with formatting attributes', () => {
            const result = parseSectionArgs('code(format="json", lang="javascript", indent="2")');
            expect(result).toEqual({
                name: 'code',
                attributes: {
                    format: 'json',
        ...
        it('should parse AI prompt section', () => {
            const result = parseSectionArgs('prompt(role="system", temperature="0.7")');
            expect(result).toEqual({
                name: 'prompt',
                attributes: {
                    role: 'system',
        ...
        it('should parse complex iteration with nested path', () => {
            const result = parseIteration('message, idx in conversation.messages.unread');
            expect(result).toEqual({
                itemName: 'message',
                indexName: 'idx',
        ...
        it('should parse conditional with string comparison', () => {
            const result = parseConditional('user.role == "admin" or user.role == "moderator"');
            expect(result).toEqual({
        ...
        it('should parse template include with parameters', () => {
            const result = parseNamedParams('"header.aptl", title="Welcome", showNav=true');
            expect(result).toEqual({
        ...
        it('should parse HTML-like attributes', () => {
            const result = parseAttributes('class="container mx-auto", id="main-content", data-value="123"');
            expect(result).toEqual({
        ...
        it('should parse markdown section attributes', () => {
            const result = parseSectionArgs('markdown(lang="en", style="github", breaks=true)');
            expect(result).toEqual({
                name: 'markdown',
                attributes: {
                    lang: 'en',
