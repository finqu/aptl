...
describe('ObjectFileSystem', () => {
    ...
    describe('Directory Operations', () => {
        ...
        describe('readdir', () => {
            ...
            it('should list root directory', async () => {
                ...
                expect(entries).toContainEqual({ path: 'file1.txt', isDirectory: false });
                expect(entries).toContainEqual({ path: 'file2.txt', isDirectory: false });
            });
    ...
    describe('Real-World Scenarios', () => {
        it('should handle template file system operations', async () => {
            ...
            // Read templates
            expect(await fs.readFile('templates/base.aptl')).toBe('@section{content}');
